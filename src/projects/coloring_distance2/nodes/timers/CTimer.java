...
public class CTimer extends Timer {
    ...
    public void fire() {
        ...
        CMessage msg= new CMessage(sender.ID,sender.getMe().getColor(), sender.getDominator(), sender.getMe().getDominatorColor(), sender.getNumberNeighbours(), sender.getMe().getSpectrum());
